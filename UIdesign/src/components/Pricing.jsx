...
function Pricing() {
  ...
  const packages = [
    {
      ...
      green: "/src/assets/greencircle.png",
    },
    {
      name: "Advance",
      monthlyPrice: 39,
  ...
  return (
    <div className="md:px-14 p-4 max-w-s py-10 mx-auto" id="pricing">
      <div className="text-center">
        <h2 className="md:text-5xl text-3xl font-extrabold text-primary mb-2 ">
          Here all are our plans
        </h2>
        ...
        <div className="mt-24">
          ...
          >
            ...
            <div className="w-14 h-6 bg-gray-300 rounded-full transition-all duration-200 ease-in-out">
              <div
                className={`w-6 h-6 rounded-full transition-all duration-200 ease-in-out ${
      ...
      <motion.div variants={fadeIn("up", 0.2)}
          initial="hidden"
          whileInView={"show"}
          viewport={{ once: false, amount: 0.5 }} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-20 md:w-11/12 mx-auto">
        {packages.map((pkg, index) => (
          <div
            key={index}
            className="border py-10 md:px-6 px-4 rounded-lg shadow-4xl"
          >
            ...
            <p className="mt-5 text-center text-secondary text-4xl font-bold">
              ...
              <span className="text-tartiary text-base font-medium">
                /{isYearly ? "year" : "month"}
              </span>
            </p>
